...
def seed_users():
    dogg = User(
        ...
        email='demo@aa.io', 
        password='password', 
        profile_img='https://th.bing.com/th/id/OIP.dG60VtWKcsGTTVayhWLdDQAAAA?pid=ImgDet&rs=1'
    )
    ...
    marquess = User(
        ...
        email='marnie@aa.io', 
        password='password', 
        profile_img='https://www.indiewire.com/wp-content/uploads/2016/06/mtm_3a5_494_jasonbsucks_still01.jpg'
    )
    ...
    yung_Hee = User(
        ...
        email='bobbie@aa.io', 
        password='password', 
        profile_img= 'https://th.bing.com/th/id/OIP.1tNZLd_KzdBuvz3eHaYsygHaEK?pid=ImgDet&rs=1'
    )
